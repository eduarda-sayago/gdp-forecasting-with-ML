...
call_models12 = function(data, model_name, model_function, variable, type = "default"){
  ...
  forecasts <- Reduce(
    f = cbind,
    x = lapply(model_list, function(x) tail(x$forecast, nwindows))
  ) %>% as.matrix()
...
call_models3 = function(data, model_name, model_function, variable, type = "default"){
