...
# h=1 RMSE: 0.07011117; MAE: 0.04844195; MAPE:     
# h=4 RMSE: 0.12220252; MAE: 0.10155142; MAPE:  

benchmark <- call_models(datasetm, 'SARIMA - IBC-m', get_sarima, "ibc_rs")
# h=1 RMSE: 0.06629558; MAE: 0.04880438; MAPE:
# h=12 RMSE: 0.10242225; MAE: 0.07750083; MAPE: 

#=====
message("LASSO")

lasso_modelp <- call_models(dataset, 'LASSO - PIB_RS', get_lasso, "pib_rs")
# h=1 RMSE: 0.05920526  ; MAE: 0.04084625; MAPE:  
# h=4 RMSE: 0.05988952  ; MAE: 0.04352576; MAPE: 

lasso_model <- call_models(datasetm, 'LASSO - IBC-m', get_lasso, "ibc_rs")
# h=1 RMSE: 0.04012251 ; MAE:  0.03249728; MAPE: 
# h=12 RMSE: 0.06383114 ; MAE: 0.04716723; MAPE: 
...
# h=1 RMSE: ; MAE:    ; MAPE:
# h=4 RMSE: ; MAE:    ; MAPE:
enet_wmodel <- call_models(datasetw, 'Elastic Net', get_elasticnet, "ibc_rs")
# h=1 RMSE: ; MAE:    ; MAPE:
# h=4 RMSE: ; MAE:    ; MAPE:
...
# h=1 RMSE: ; MAE:     
# h=4 RMSE: ; MAE:  
rf_wmodel <- call_models(datasetw, 'Random Forest', get_rf, "ibc_rs")
# h=1 RMSE: ; MAE:     
# h=4 RMSE: ; MAE:  

message("Boosting")

boost_model <- call_models(datasetm, 'Boosting', get_boosting, "ibc_rs")
# h=1 RMSE: ; MAE:      
# h=4 RMSE: ; MAE:   
boost_wmodel <- call_models(datasetw, 'Boosting', get_boosting, "ibc_rs")
# h=1 RMSE: ; MAE:      
# h=4 RMSE: ; MAE:  
